...
public class MaxAccessTimeDriver extends Configured implements Tool {
	public static void main(String[] args) throws Exception {
	
		int exitCode = ToolRunner.run(new Configuration(),new MaxAccessTimeDriver(), args);
	...
	public int run(String[] args) throws Exception {
		...
		if (args.length != 2) {
		    ...
		    job.setJarByClass(MaxAccessTimeDriver.class);
		    ...
		    job.setMapperClass(MaxAccessTimeMapper.class);
		    job.setReducerClass(MaxAccessTimeReducer.class);
		  ...
		  //Setting the type of the key-value pair to write in the output file.
		    ...
		    //Setting the grouping and sorting comparator classes
		      job.setGroupingComparatorClass(IPComparator.class);
